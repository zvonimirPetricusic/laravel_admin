(function() {
    ...
    var categories = function () {
        ...
        var filter_category_id, filter_subcategory_id, filter_sub_subcategory_id, filter_price_min, filter_price_max = false;


        var init = function(filter_category_id, filter_subcategory_id, filter_sub_subcategory_id, filter_price_min, filter_price_max){
            
            $.ajax({
                url: "/api/products?filter_category_id=" + filter_category_id + 
                                    '&filter_subcategory_id=' + filter_subcategory_id + 
                                    '&filter_sub_subcategory_id=' + filter_sub_subcategory_id + 
                    ...
                    $.each(data, function (index, product) {
                        products += 
                            '<div class="col-md-4">' +
                                ...
                                '<img class="card-img-top" src="' + siteUrl + 'storage/img/' + product.path + '" alt="Card image cap"/>' +
                                        '<p class="card-text">' + product.description + '</p>' +
                                        '<a href="' + siteUrl + 'product?id=' + product.id + '" class="btn btn-primary">More</a>' +
                                    '</div>' +
                                '</div>' +
                            '</div>';
                    });
